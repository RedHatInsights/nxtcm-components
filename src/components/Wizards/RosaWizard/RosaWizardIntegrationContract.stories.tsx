...
import type { RosaWizardSubmitHandler } from './RosaWizard';
...
const integrationContractOnSubmit: RosaWizardSubmitHandler = async (data) => {
  void data.cluster;
};
...
This story keeps \`wizardsStepsData\` and the submit handler typed as \`RosaWizardSubmitHandler\`, matching \`WizardWrapper\` and \`RosaWizard\` props.
`,
      },
    },
  },

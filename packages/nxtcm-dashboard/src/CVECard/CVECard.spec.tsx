...
test.describe('CVECard', () => {
  ...
  test('should render the correct count for critical CVEs', async ({ mount, page }) => {
    await mount('nxtcm-dashboard/CVECard/CVECard/CVECardStory', { cveData: mockCVEData });
  ...
  test('should apply custom className when provided', async ({ mount, page }) => {
    await mount('nxtcm-dashboard/CVECard/CVECard/CVECardStory', {
      cveData: mockCVEData,
...
test('should render with empty cveData array', async ({ mount }) => {
  const component = await mount('nxtcm-dashboard/CVECard/CVECard/CVECardStory', { cveData: [] });

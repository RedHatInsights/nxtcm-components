...
export const defaultRosaHcpWizardStrings: RosaHcpWizardStrings = {
  ...
  yamlEditor: {
    ...
    parseErrorTitle: 'YAML Schema Validation Error',
    convertError: 'Error converting form data to YAML',
    invalidYaml: 'Invalid YAML syntax',
    discardChanges: 'Discard changes and go back to Review step',
    discardConfirmTitle: 'Discard YAML changes?',
    discardConfirmBody: 'Any changes you made to the YAML configuration will be lost.',
    discardConfirmYes: 'Yes',
    cancelCreation: 'Cancel cluster creation',
    schemaTitle: 'ROSAControlPlane schema',
    schemaToggleAriaLabel: 'Toggle schema panel',
    schemaShowTooltip: 'Show schema',
    schemaHideTooltip: 'Hide sidebar',
    schemaSearchPlaceholder: 'Search schema fields...',
  },
  associateAwsDrawer: {
  ...
  rolesAndPolicies: {
    ...
    operatorRolesCreateLabel: 'Create operator roles',

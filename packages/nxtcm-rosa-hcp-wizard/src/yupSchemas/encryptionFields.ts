...
export const etcdEncryptionSchema = yup
  ...
  .meta({
    ...
    resetsFieldsToDefaultOnChange:
      YUP.ENCRYPTION.ETCD_ENCRYPTION_SCHEMA.META.RESETS_FIELDS_TO_DEFAULT_ON_CHANGE,
  } satisfies WizardFieldMeta);
...
export const etcdKeyArnSchema = yup
  ...
  .meta({
    ...
    labelHelpKey: YUP.ENCRYPTION.ETCD_KEY_ARN_SCHEMA.META.LABEL_HELP_KEY,
    stepId: YUP.ENCRYPTION.ETCD_KEY_ARN_SCHEMA.META.STEP_ID,
    fieldType: YUP.ENCRYPTION.ETCD_KEY_ARN_SCHEMA.META.FIELD_TYPE,
    noEditAfterSubmit: YUP.ENCRYPTION.ETCD_KEY_ARN_SCHEMA.META.NO_EDIT_AFTER_SUBMIT,
  } satisfies WizardFieldMeta)

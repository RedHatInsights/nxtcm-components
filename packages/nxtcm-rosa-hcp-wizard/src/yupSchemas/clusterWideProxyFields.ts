...
export const httpsProxyUrlSchema = yup
  ...
  .meta({
    ...
    resetsFieldsToDefaultOnChange:
      YUP.CLUSTER_WIDE_PROXY.HTTPS_PROXY_URL_SCHEMA.META.RESETS_FIELDS_TO_DEFAULT_ON_CHANGE,
  } satisfies WizardFieldMeta)
...
export const additionalTrustBundleSchema = yup
  ...
  .meta({
    ...
    labelKey: YUP.CLUSTER_WIDE_PROXY.ADDITIONAL_TRUST_BUNDLE_SCHEMA.META.LABEL_KEY,
    stepId: YUP.CLUSTER_WIDE_PROXY.ADDITIONAL_TRUST_BUNDLE_SCHEMA.META.STEP_ID,
    fieldType: YUP.CLUSTER_WIDE_PROXY.ADDITIONAL_TRUST_BUNDLE_SCHEMA.META.FIELD_TYPE,
    collapseOnRequired:
      YUP.CLUSTER_WIDE_PROXY.ADDITIONAL_TRUST_BUNDLE_SCHEMA.META.COLLAPSE_ON_REQUIRED,
  } satisfies WizardFieldMeta)

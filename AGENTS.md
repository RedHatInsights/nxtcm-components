...
| what | where |
|------|-------|
| components | `src/components/{FeatureArea}/{ComponentName}/` |
| shared types | `src/types/` |
| utilities | `src/utilities/` |
| context providers | `src/context/` |
| playwright CT helpers | `src/test-helpers.ts` |
| public exports | `src/index.ts` |
| E2E tests | `playwright/e2e/` |
| react-form-wizard | `packages/react-form-wizard/` (separate package) |
